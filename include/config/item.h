...
// Item config
#define I_SHINY_CHARM_ADDITIONAL_ROLLS  4           // The amount of additional Shiny rolls if the player has the Shiny Charm. Set it to 0 to disable the Shiny Charm's effects.

...
#define I_EXP_SHARE_FLAG        FLAG_I_EXP_SHARE           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define I_ORAS_DOWSING_FLAG         FLAG_I_ORAS_DOWSING           // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.

...
#define I_EXP_SHARE_FLAG        FLAG_SYS_ITEM_EXP_SHARE_FLAG           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        FLAG_SYS_ITEM_VS_SEEKER_CHARGING     // If this flag is assigned, the Vs Seeker functionality will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working.

...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_B_FOLLOWERS_DISABLED          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.

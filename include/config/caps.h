...
#define B_LEVEL_CAP_VARIABLE            VAR_EXP_CAP // event variable used to derive level cap if B_LEVEL_CAP_TYPE is set to LEVEL_CAP_VARIABLE
...
#define B_EV_CAP_VARIABLE               VAR_EV_CAP // event variable used to derive EV cap if B_EV_CAP_TYPE is set to EV_CAP_VARIABLE

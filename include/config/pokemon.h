...
#define P_FLAG_FORCE_SHINY               FLAG_SYS_POKEMON_FORCE_SHINY  // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY            FLAG_SYS_POKEMON_FORCE_NO_SHINY  // If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.

// Move Relearner settings
#define P_VAR_MOVE_RELEARNER_STATE       VAR_SYS_MOVE_TUTOR      // IMPORTANT! Assign a var to make the move relearner swap between level up, egg, TM and tutor.
...
#define P_FLAG_PARTY_MOVE_RELEARNER      FLAG_SYS_PARTY_MOVE_RELEARNER      // If this flag is set, it enables the move relearner in the party menu.
#define P_FLAG_SCRIPT_MOVE_RELEARNER     FLAG_SYS_SCRIPT_MOVE_RELEARNER      // Set this flag if you're planning on using the move relearner script from data/scripts/move_relearner.inc
// Redundant if P_ENABLE_MOVE_RELEARNERS is TRUE.
#define P_FLAG_LEVEL_UP_MOVES            FLAG_SYS_LEVEL_UP_MOVES      // If this flag is set, enables level up move relearner.
#define P_FLAG_EGG_MOVES                 FLAG_SYS_EGG_MOVES      // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               FLAG_SYS_TUTOR_MOVES      // If this flag is set, enables tutor move move relearner.

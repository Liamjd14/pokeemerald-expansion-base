...
#define P_FLAG_FORCE_SHINY               FLAG_P_FLAG_FORCE_SHINY  // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY            FLAG_P_FLAG_FORCE_NO_SHINY  // If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.

...
#define B_FLAG_NO_BAG_USE           FLAG_B_NO_BAG_USE     // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_VAR_STARTING_STATUS       VAR_B_VAR_STARTING_STATUS     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
                                          // This var should never remain non-zero long enough for the player to save.
#define B_VAR_STARTING_STATUS_TIMER VAR_B_VAR_STARTING_STATUS_TIMER     // If this var has a value greater or equal than 1 field terrains will last that number of turns, otherwise they will last until they're overwritten.

...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_SYS_DN_SEARCHING // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_SYS_DN_DEXNAV_GET // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_SYS_DN_DETECTOR_MODE // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_SYS_DN_SPECIES // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_SYS_DN_STEPCOUNT // Steps for finding hidden pokemon
...
#define SEARCHLEVEL0_MOVECHANCE         20
...
#define SEARCHLEVEL0_ONESTAR            20
...
#define SEARCHLEVEL0_THREESTAR          5

...
#define VAR_SYS_LEVEL_CAP_VARIABLE                       0x40FB // Unused Var
#define VAR_SYS_SKY_BATTLE                               0x40FC // Unused Var
#define VAR_SYS_WILD_AI_FLAGS                            0x40FD // Unused Var
#define VAR_SYS_STARTING_STATUS_TIMER                    0x40FE // Unused Var
#define VAR_SYS_STARTING_STATUS                          0x40FF // Unused Var

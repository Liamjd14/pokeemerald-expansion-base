...
#define VAR_SYS_B_STARTING_STATUS                        0x40F7 // Unused Var
#define VAR_SYS_B_STARTING_TIMER                         0x40F8 // Unused Var
#define VAR_SYS_B_WILD_AI_FLAG                           0x40F9 // Unused Var
#define VAR_SYS_B_DIFICULTY                              0x40FA // Unused Var
#define VAR_SYS_B_SKY_BATTLE                             0x40FB // Unused Var
#define VAR_SYS_DN_SPECIES                               0x40FC // Unused Var
#define VAR_SYS_DN_STEPCOUNT                             0x40FD // Unused Var
#define VAR_SYS_CURRENT_SEASON                           0x40FE // Unused Var
#define VAR_SYS_MOVERELERNER_STATE                       0x40FF // Unused Var

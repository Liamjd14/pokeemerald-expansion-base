...
#define VAR_B_VAR_WILD_AI_FLAGS                          0x40F8 // Unused Var
#define VAR_B_VAR_DIFFICULTY                             0x40F9 // Unused Var
#define VAR_B_VAR_NO_BAG_USE                             0x40FA // Unused Var
#define VAR_B_VAR_SKY_BATTLE                             0x40FB // Unused Var
#define VAR_B_LEVEL_CAP_VARIABLE                         0x40FC // Unused Var
#define VAR_DN_VAR_SPECIES                               0x40FD // Unused Var
#define VAR_DN_VAR_STEP_COUNTER                          0x40FE // Unused Var
#define VAR_GAME_CORNER_VAR_WINNINGS                     0x40FF // Unused Var

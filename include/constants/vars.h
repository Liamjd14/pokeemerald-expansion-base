...
#define VAR_B_STARTING_STATUS                            0x40F8 // Unused Var
#define VAR_B_STARTING_STATUS_TIMER                      0x40F9 // Unused Var
#define VAR_B_WILD_AI_FLAGS                              0x40FA // Unused Var
#define VAR_B_NO_BAG_USE                                 0x40FB // Unused Var
#define VAR_B_SKY_BATTLE                                 0x40FC // Unused Var
#define VAR_B_DIFFICULTY                                 0x40FD // Unused Var
#define VAR_DN_SPECIES                                   0x40FE // Unused Var
#define VAR_DN_STEP_COUNTER                              0x40FF // Unused Var

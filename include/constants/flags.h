...
#define FLAG_HIDDEN_ITEMS_END FLAG_UNUSED_0x2BB
...
#define FLAG_B_FLAG_AI_VS_AI_BATTLE                 (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_B_FLAG_DYNAMAX_BATTLE                  (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_B_FLAG_TERA_ORB_CHARGED                (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_B_FLAG_TERA_ORB_NO_COST                (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_B_FLAG_SLEEP_CLAUSE                    (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_B_FLAG_NO_WHITEOUT                     (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_B_FLAG_MULTIPLE_MEGAS                  (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_B_FLAG_SKY_BATTLE                      (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_B_FLAG_VICTORY_CATCH_RANDOM            (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_B_FLAG_VICTORY_CATCH_GUARANTEED        (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_B_FLAG_BXPY                            (SYSTEM_FLAGS + 0x90) // Unused Flag
...
#define FLAG_P_FLAG_FORCE_SHINY                     (SYSTEM_FLAGS + 0x9A) // Unused Flag
#define FLAG_P_FLAG_FORCE_NO_SHINY                  (SYSTEM_FLAGS + 0x9B) // Unused Flag
#define FLAG_P_POKERUS_FLAG_INFECTION               (SYSTEM_FLAGS + 0x9C) // Unused Flag
#define FLAG_FLAG_TEXT_SPEED_INSTANT                (SYSTEM_FLAGS + 0x9D) // Unused Flag
#define FLAG_WE_FLAG_NO_ENCOUNTER                   (SYSTEM_FLAGS + 0x9E) // Unused Flag
#define FLAG_WE_FLAG_FORCE_DOUBLE_WILD              (SYSTEM_FLAGS + 0x9F) // Unused Flag
#define FLAG_WE_SMART_WILD_AI_FLAG                  (SYSTEM_FLAGS + 0xA0) // Unused Flag
#define FLAG_WE_FLAG_NO_CATCHING                    (SYSTEM_FLAGS + 0xA1) // Unused Flag
#define FLAG_WE_FLAG_NO_RUNNING                     (SYSTEM_FLAGS + 0xA2) // Unused Flag
#define FLAG_WE_OWE_FLAG_DISABLED                   (SYSTEM_FLAGS + 0xA3) // Unused Flag

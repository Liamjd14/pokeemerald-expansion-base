...
#define FLAG_CROSSOVER_IS_FRLG                        0x770 // Unused Flag
...
#define FLAG_B_FLAG_INVERSE_BATTLE                  (SYSTEM_FLAGS + 0x7A) // Unused Flag
#define FLAG_B_FLAG_AI_VS_AI_BATTLE                 (SYSTEM_FLAGS + 0x7B) // Unused Flag
#define FLAG_B_FLAG_DYNAMAX_BATTLE                  (SYSTEM_FLAGS + 0x7C) // Unused Flag
#define FLAG_B_FLAG_TERA_ORB_CHARGED                (SYSTEM_FLAGS + 0x7D) // Unused Flag
#define FLAG_B_FLAG_TERA_ORB_NO_COST                (SYSTEM_FLAGS + 0x7E) // Unused Flag
#define FLAG_B_FLAG_SLEEP_CLAUSE                    (SYSTEM_FLAGS + 0x7F) // Unused Flag

#define FLAG_B_FLAG_NO_WHITEOUT                     (SYSTEM_FLAGS + 0x80) // Unused Flag
#define FLAG_B_FLAG_MULTIPLE_MEGAS                  (SYSTEM_FLAGS + 0x81) // Unused Flag
#define FLAG_B_FLAG_SKY_BATTLE                      (SYSTEM_FLAGS + 0x82) // Unused Flag
#define FLAG_B_FLAG_VICTORY_CATCH_RANDOM            (SYSTEM_FLAGS + 0x83) // Unused Flag
#define FLAG_B_FLAG_VICTORY_CATCH_GUARANTEED        (SYSTEM_FLAGS + 0x84) // Unused Flag
#define FLAG_B_FLAG_BXPY                            (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_DN_FLAG_SEARCHING                      (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_DN_FLAG_DEXNAV_GET                     (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_DN_FLAG_DETECTOR_MODE                  (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_FNPC_FLAG_HEAL_AFTER_FOLLOWER_BATTLE   (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_FNPC_FLAG_PARTNER_WILD_BATTLES         (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_I_EXP_SHARE_FLAG                       (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_I_VS_SEEKER_CHARGING                   (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_OW_FLAG_SUPPRESS_NAME_BOX              (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_B_FLAG_FOLLOWERS_DISABLED              (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_P_FLAG_FORCE_SHINY                     (SYSTEM_FLAGS + 0x8F) // Unused Flag

#define FLAG_P_FLAG_FORCE_NO_SHINY                  (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_P_POKERUS_FLAG_INFECTION               (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_FLAG_TEXT_SPEED_INSTANT                (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_WE_FLAG_NO_ENCOUNTER                   (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_WE_FLAG_FORCE_DOUBLE_WILD              (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_WE_SMART_WILD_AI_FLAG                  (SYSTEM_FLAGS + 0x95) // Unused Flag
...
#define FLAG_HIDE_BULBASAUR_BALL                           0x960
#define FLAG_HIDE_SQUIRTLE_BALL                            0x961
#define FLAG_HIDE_CHARMANDER_BALL                          0x962
#define FLAG_HIDE_OAK_IN_HIS_LAB                           0x963
#define FLAG_HIDE_OAK_IN_PALLET_TOWN                       0x964
#define FLAG_HIDE_RIVAL_IN_LAB                             0x965
#define FLAG_HIDE_PEWTER_CITY_GYM_GUIDE                    0x966
#define FLAG_HIDE_DOME_FOSSIL                              0x967
#define FLAG_HIDE_HELIX_FOSSIL                             0x968
#define FLAG_HIDE_NUGGET_BRIDGE_ROCKET                     0x969
#define FLAG_HIDE_BILL_CLEFAIRY                            0x96A
#define FLAG_HIDE_BILL_HUMAN_SEA_COTTAGE                   0x96B
#define FLAG_HIDE_HIDEOUT_GIOVANNI                         0x970
#define FLAG_HIDE_TOWN_MAP                                 0x971
#define FLAG_HIDE_POKEDEX                                  0x972
#define FLAG_HIDE_CERULEAN_ROCKET                          0x973
#define FLAG_HIDE_CERULEAN_RIVAL                           0x974
#define FLAG_HIDE_SS_ANNE_RIVAL                            0x975
#define FLAG_HIDE_SAFFRON_ROCKETS                          0x976
#define FLAG_HIDE_SAFFRON_CIVILIANS                        0x977
#define FLAG_HIDE_SEAFOAM_1F_BOULDER_1                     0x978
#define FLAG_HIDE_SEAFOAM_1F_BOULDER_2                     0x979
#define FLAG_HIDE_SEAFOAM_B1F_BOULDER_1                    0x97A
#define FLAG_HIDE_SEAFOAM_B1F_BOULDER_2                    0x97B
#define FLAG_HIDE_SEAFOAM_B2F_BOULDER_1                    0x97C
#define FLAG_HIDE_SEAFOAM_B2F_BOULDER_2                    0x97D
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_1                    0x97E
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_2                    0X97F
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_3                    0x981
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_4                    0x982
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_5                    0x983
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_6                    0x984
#define FLAG_HIDE_SEAFOAM_B4F_BOULDER_1                    0x985
#define FLAG_HIDE_SEAFOAM_B4F_BOULDER_2                    0x986
#define FLAG_HIDE_SILPH_RIVAL                              0x987
#define FLAG_HIDE_ROUTE_22_RIVAL                           0x988
#define FLAG_HIDE_PEWTER_MUSEUM_GUIDE                      0x989
#define FLAG_HIDE_TOWER_RIVAL                              0x98A
#define FLAG_HIDE_MOLTRES                                  0x98B
#define FLAG_HIDE_SILPH_ROCKETS                            0x98C
#define FLAG_HIDE_ROUTE_12_SNORLAX                         0x98D
#define FLAG_HIDE_VIRIDIAN_GIOVANNI                        0x98E
#define FLAG_HIDE_OLD_AMBER                                0x98F
#define FLAG_HIDE_EEVEE_BALL                               0x991
#define FLAG_HIDE_VICTORY_ROAD_2F_BOULDER                  0x992
#define FLAG_HIDE_VICTORY_ROAD_3F_BOULDER                  0x993
#define FLAG_HIDE_OAK_IN_CHAMP_ROOM                        0x994
#define FLAG_HIDE_GAME_CORNER_ROCKET                       0x995
#define FLAG_HIDE_CERULEAN_CAVE_GUARD                      0x996
#define FLAG_HIDE_ZAPDOS                                   0x997
#define FLAG_HIDE_TOWER_ROCKET_1                           0x998
#define FLAG_HIDE_CELADON_ROCKETS                          0x999 
#define FLAG_HIDE_DOJO_HITMONLEE_BALL                      0x99A
#define FLAG_HIDE_DOJO_HITMONCHAN_BALL                     0x99B
#define FLAG_HIDE_CINNABAR_BILL                            0x99C
#define FLAG_HIDE_UNION_ROOM_PLAYER_1                      0x99D
#define FLAG_HIDE_UNION_ROOM_PLAYER_2                      0x99E
#define FLAG_HIDE_UNION_ROOM_PLAYER_3                      0x99F

#define FLAG_HIDE_UNION_ROOM_PLAYER_4                      0x9A0
#define FLAG_HIDE_UNION_ROOM_PLAYER_5                      0x9A1
#define FLAG_HIDE_UNION_ROOM_PLAYER_6                      0x9A2
#define FLAG_HIDE_UNION_ROOM_PLAYER_7                      0x9A3
#define FLAG_HIDE_UNION_ROOM_PLAYER_8                      0x9A4
#define FLAG_HIDE_CINNABAR_SEAGALLOP                       0x9A5
#define FLAG_HIDE_SAFFRON_FAN_CLUB_BLACKBELT               0x9A6
#define FLAG_HIDE_SAFFRON_FAN_CLUB_ROCKER                  0x9A7
#define FLAG_HIDE_SAFFRON_FAN_CLUB_WOMAN                   0x9A8
#define FLAG_HIDE_SAFFRON_FAN_CLUB_BEAUTY                  0x9A9
#define FLAG_HIDE_MG_DELIVERYMEN                           0x9AA
#define FLAG_HIDE_ONE_ISLAND_BILL                          0x9AB
#define FLAG_HIDE_ONE_ISLAND_POKECENTER_BILL               0x9AC
#define FLAG_HIDE_ONE_ISLAND_POKECENTER_CELIO              0x9AD
#define FLAG_HIDE_TWO_ISLAND_GAME_CORNER_BIKER             0x9AE
#define FLAG_HIDE_TWO_ISLAND_GAME_CORNER_LOSTELLE          0x9AF
#define FLAG_HIDE_LOSTELLE_IN_HER_HOME                     0x9B0
#define FLAG_0x077                                         0x9B1
#define FLAG_0x078                                         0x9B2
#define FLAG_HIDE_THREE_ISLAND_BIKERS                      0x9B3
#define FLAG_HIDE_LOSTELLE_IN_BERRY_FOREST                 0x9B4
#define FLAG_HIDE_TWO_ISLAND_WOMAN                         0x9B5
#define FLAG_HIDE_TWO_ISLAND_BEAUTY                        0x9B6
#define FLAG_HIDE_TWO_ISLAND_SUPER_NERD                    0x9B7
#define FLAG_HIDE_THREE_ISLAND_ANTIBIKERS                  0x9B8
#define FLAG_0x07F                                         0x9B9
#define FLAG_HIDE_ROUTE_16_SNORLAX                         0x9BA
#define FLAG_HIDE_MEWTWO                                   0x9BB
#define FLAG_HIDE_ARTICUNO                                 0x9BC
#define FLAG_HIDE_TOWER_ROCKET_2                           0x9BD
#define FLAG_HIDE_TOWER_ROCKET_3                           0x9BE
#define FLAG_HIDE_POWER_PLANT_ELECTRODE_1                  0x9BF
#define FLAG_HIDE_POWER_PLANT_ELECTRODE_2                  0x9C0
#define FLAG_HIDE_SS_ANNE                                  0x9C1
#define FLAG_HIDE_FIVE_ISLAND_ROCKETS                      0x9C2
#define FLAG_HIDE_MT_EMBER_EXTERIOR_ROCKETS                0x9C3
#define FLAG_HIDE_RUBY                                     0x9C4
#define FLAG_HIDE_ICEFALL_CAVE_LORELEI                     0x9C5
#define FLAG_HIDE_LORELEI_IN_HER_HOUSE                     0x9C6
#define FLAG_HIDE_ICEFALL_CAVE_ROCKETS                     0x9C7
#define FLAG_HIDE_RUIN_VALLEY_SCIENTIST                    0x9C8
#define FLAG_HIDE_SAPPHIRE                                 0x9C9
#define FLAG_HIDE_DOTTED_HOLE_SCIENTIST                    0x9CA
#define FLAG_HIDE_THREE_ISLAND_LONE_BIKER                  0x9CB
#define FLAG_HIDE_PEWTER_CITY_RUNNING_SHOES_GUY            0x9CC
#define FLAG_HIDE_LOST_CAVE_SELPHY                         0x9CD
#define FLAG_HIDE_RESORT_GORGEOUS_SELPHY                   0x9CE
#define FLAG_HIDE_RESORT_GORGEOUS_INSIDE_SELPHY            0x9CF
#define FLAG_HIDE_SELPHYS_BUTLER                           0x9D0
#define FLAG_HIDE_FOUR_ISLAND_RIVAL                        0x9D1
#define FLAG_HIDE_SIX_ISLAND_POKECENTER_RIVAL              0x9D2
#define FLAG_HIDE_BIRTH_ISLAND_METEORITE                   0x9D3
#define FLAG_HIDE_POSTGAME_GOSSIPERS                       0x9D4
#define FLAG_HIDE_FAME_CHECKER_ERIKA_JOURNALS              0x9D5
#define FLAG_HIDE_FAME_CHECKER_KOGA_JOURNAL                0x9D6
#define FLAG_HIDE_FAME_CHECKER_LT_SURGE_JOURNAL            0x9D7
#define FLAG_HIDE_VERMILION_CITY_OAKS_AIDE                 0x9D8
#define FLAG_HIDE_CINNABAR_POKECENTER_BILL                 0x9D9
#define FLAG_HIDE_CREDITS_RIVAL                            0x9DA
#define FLAG_HIDE_CREDITS_OAK                              0x9DB
#define FLAG_HIDE_LORELEI_HOUSE_MEOWTH_DOLL                0x9DC
#define FLAG_HIDE_LORELEI_HOUSE_CHANSEY_DOLL               0x9DD
#define FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_F_DOLL            0x9DE
#define FLAG_HIDE_LORELEI_HOUSE_JIGGLYPUFF_DOLL            0x9DF
#define FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_M_DOLL            0x9E0
#define FLAG_HIDE_LORELEIS_HOUSE_FEAROW_DOLL               0x9E1
#define FLAG_HIDE_LORELEIS_HOUSE_PIDGEOT_DOLL              0x9E2
#define FLAG_HIDE_LORELEIS_HOUSE_LAPRAS_DOLL               0x9E3
#define FLAG_HIDE_MISC_KANTO_ROCKETS                       0x9E4
#define FLAG_HIDE_SAFFRON_CITY_POKECENTER_SABRINA_JOURNALS 0x9E5

#define FLAG_HIDE_ROUTE2_ETHER                                  0x9E6
#define FLAG_HIDE_ROUTE2_PARALYZE_HEAL                          0x9E7
#define FLAG_HIDE_VIRIDIAN_FOREST_POKE_BALL                     0x9E8
#define FLAG_HIDE_VIRIDIAN_FOREST_ANTIDOTE                      0x9E9
#define FLAG_HIDE_VIRIDIAN_FOREST_POTION                        0x9EA
#define FLAG_HIDE_MT_MOON_1F_PARALYZE_HEAL                      0x9EB
#define FLAG_HIDE_MT_MOON_1F_TM09                               0x9EC
#define FLAG_HIDE_MT_MOON_1F_POTION                             0x9ED
#define FLAG_HIDE_MT_MOON_1F_RARE_CANDY                         0x9EE
#define FLAG_HIDE_MT_MOON_1F_ESCAPE_ROPE                        0x9EF
#define FLAG_HIDE_MT_MOON_1F_MOON_STONE                         0x9F0
#define FLAG_HIDE_MT_MOON_B2F_STAR_PIECE                        0x9F1
#define FLAG_HIDE_MT_MOON_B2F_TM46                              0x9F2
#define FLAG_HIDE_ROUTE4_TM05                                   0x9F3
#define FLAG_HIDE_ROUTE24_TM45                                  0x9F4
#define FLAG_HIDE_ROUTE25_TM43                                  0x9F5
#define FLAG_HIDE_SSANNE_1F_ROOM2_TM31                          0x9F6
#define FLAG_HIDE_SSANNE_2F_ROOM2_STARDUST                      0x9F7
#define FLAG_HIDE_SSANNE_2F_ROOM4_X_ATTACK                      0x9F8
#define FLAG_HIDE_SSANNE_B1F_ROOM2_TM44                         0x9F9
#define FLAG_HIDE_SSANNE_B1F_ROOM3_ETHER                        0x9FA
#define FLAG_HIDE_SSANNE_B1F_ROOM5_SUPER_POTION                 0x9FB
#define FLAG_HIDE_SSANNE_KITCHEN_GREAT_BALL                     0x9FC
#define FLAG_HIDE_ROUTE9_TM40                                   0x9FD
#define FLAG_HIDE_ROCKET_HIDEOUT_B1F_ESCAPE_ROPE                0x9FE
#define FLAG_HIDE_ROCKET_HIDEOUT_B1F_HYPER_POTION               0x9Ff
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_X_SPEED                    0xA00
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_MOON_STONE                 0xA01
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_TM12                       0xA02
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_SUPER_POTION               0xA03
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_RARE_CANDY                 0xA04
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_TM21                       0xA05
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_TM49                       0xA06
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_MAX_ETHER                  0xA07
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_CALCIUM                    0xA08
#define FLAG_HIDE_POKEMON_TOWER_3F_ESCAPE_ROPE                  0xA09
#define FLAG_HIDE_POKEMON_TOWER_4F_ELIXIR                       0xA0A
#define FLAG_HIDE_POKEMON_TOWER_4F_AWAKENING                    0xA0B
#define FLAG_HIDE_POKEMON_TOWER_4F_GREAT_BALL                   0xA0C
#define FLAG_HIDE_POKEMON_TOWER_5F_NUGGET                       0xA0D
#define FLAG_HIDE_POKEMON_TOWER_6F_RARE_CANDY                   0xA0E
#define FLAG_HIDE_POKEMON_TOWER_6F_X_ACCURACY                   0xA0F
#define FLAG_HIDE_ROUTE12_TM48                                  0xA10
#define FLAG_HIDE_ROUTE12_IRON                                  0xA11
#define FLAG_HIDE_ROUTE15_TM18                                  0xA12
#define FLAG_HIDE_SAFARI_ZONE_CENTER_NUGGET                     0xA13
#define FLAG_HIDE_SAFARI_ZONE_EAST_MAX_POTION                   0xA14
#define FLAG_HIDE_SAFARI_ZONE_EAST_FULL_RESTORE                 0xA15
#define FLAG_HIDE_SAFARI_ZONE_EAST_TM11                         0xA16
#define FLAG_HIDE_SAFARI_ZONE_EAST_LEAF_STONE                   0xA17
#define FLAG_HIDE_SAFARI_ZONE_NORTH_PROTEIN                     0xA18
#define FLAG_HIDE_SAFARI_ZONE_NORTH_TM47                        0xA19
#define FLAG_HIDE_SAFARI_ZONE_WEST_TM32                         0xA1A
#define FLAG_HIDE_SAFARI_ZONE_WEST_GOLD_TEETH                   0xA1B
#define FLAG_HIDE_SAFARI_ZONE_WEST_MAX_POTION                   0xA1C
#define FLAG_HIDE_SAFARI_ZONE_WEST_MAX_REVIVE                   0xA1D
#define FLAG_HIDE_SILPH_CO_3F_HYPER_POTION                      0xA1E
#define FLAG_HIDE_SILPH_CO_4F_MAX_REVIVE                        0xA1F
#define FLAG_HIDE_SILPH_CO_4F_ESCAPE_ROPE                       0xA20
#define FLAG_HIDE_SILPH_CO_4F_FULL_HEAL                         0xA21
#define FLAG_HIDE_SILPH_CO_5F_PROTEIN                           0xA22
#define FLAG_HIDE_SILPH_CO_5F_TM01                              0xA23
#define FLAG_HIDE_SILPH_CO_5F_CARD_KEY                          0xA24
#define FLAG_HIDE_SILPH_CO_6F_HP_UP                             0xA25
#define FLAG_HIDE_SILPH_CO_6F_X_SPECIAL                         0xA26
#define FLAG_HIDE_SILPH_CO_7F_CALCIUM                           0xA27
#define FLAG_HIDE_SILPH_CO_7F_TM08                              0xA28
#define FLAG_HIDE_SILPH_CO_10F_CARBOS                           0xA29
#define FLAG_HIDE_SILPH_CO_10F_ULTRA_BALL                       0xA2A
#define FLAG_HIDE_SILPH_CO_10F_RARE_CANDY                       0xA2B
#define FLAG_HIDE_POWER_PLANT_MAX_POTION                        0xA2C
#define FLAG_HIDE_POWER_PLANT_TM17                              0xA2D
#define FLAG_HIDE_POWER_PLANT_TM25                              0xA2E
#define FLAG_HIDE_POWER_PLANT_THUNDER_STONE                     0xA2F
#define FLAG_HIDE_POWER_PLANT_ELIXIR                            0xA30
#define FLAG_HIDE_POKEMON_MANSION_1F_CARBOS                     0xA31
#define FLAG_HIDE_POKEMON_MANSION_1F_ESCAPE_ROPE                0xA32
#define FLAG_HIDE_POKEMON_MANSION_2F_CALCIUM                    0xA33
#define FLAG_HIDE_POKEMON_MANSION_3F_MAX_POTION                 0xA34
#define FLAG_HIDE_POKEMON_MANSION_3F_IRON                       0xA35
#define FLAG_HIDE_POKEMON_MANSION_B1F_TM14                      0xA36
#define FLAG_HIDE_POKEMON_MANSION_B1F_FULL_RESTORE              0xA37
#define FLAG_0x1A6                                              0xA38
#define FLAG_HIDE_POKEMON_MANSION_B1F_TM22                      0xA39
#define FLAG_HIDE_POKEMON_MANSION_B1F_SECRET_KEY                0xA3A
#define FLAG_HIDE_VICTORY_ROAD_1F_RARE_CANDY                    0xA3B
#define FLAG_HIDE_VICTORY_ROAD_1F_TM02                          0xA3C
#define FLAG_HIDE_VICTORY_ROAD_2F_GUARD_SPEC                    0xA3D
#define FLAG_HIDE_VICTORY_ROAD_2F_TM07                          0xA3E
#define FLAG_HIDE_VICTORY_ROAD_2F_FULL_HEAL                     0xA3F
#define FLAG_HIDE_VICTORY_ROAD_2F_TM37                          0xA40
#define FLAG_HIDE_VICTORY_ROAD_3F_MAX_REVIVE                    0xA41
#define FLAG_HIDE_VICTORY_ROAD_3F_TM50                          0xA42
#define FLAG_HIDE_CERULEAN_CAVE_1F_MAX_ELIXIR                   0xA43
#define FLAG_HIDE_CERULEAN_CAVE_1F_NUGGET                       0xA44
#define FLAG_HIDE_CERULEAN_CAVE_1F_FULL_RESTORE                 0xA45
#define FLAG_HIDE_CERULEAN_CAVE_2F_FULL_RESTORE                 0xA46
#define FLAG_HIDE_CERULEAN_CAVE_2F_PP_UP                        0xA47
#define FLAG_HIDE_CERULEAN_CAVE_2F_ULTRA_BALL                   0xA48
#define FLAG_HIDE_CERULEAN_CAVE_B1F_MAX_REVIVE                  0xA49
#define FLAG_HIDE_CERULEAN_CAVE_B1F_ULTRA_BALL                  0xA4A
#define FLAG_HIDE_FUCHSIA_CITY_WARDENS_HOUSE_RARE_CANDY         0xA4B
#define FLAG_HIDE_TWO_ISLAND_REVIVE                             0xA4C
#define FLAG_HIDE_THREE_ISLAND_ZINC                             0xA4D
#define FLAG_0x1BC                                              0xA4E
#define FLAG_0x1BD                                              0xA4F
#define FLAG_HIDE_VIRIDIAN_FOREST_POTION_2                      0xA50
#define FLAG_HIDE_MT_MOON_B2F_REVIVE                            0xA51
#define FLAG_HIDE_MT_MOON_B2F_ANTIDOTE                          0xA52
#define FLAG_HIDE_ROUTE11_X_DEFEND                              0xA53
#define FLAG_HIDE_ROUTE9_BURN_HEAL                              0xA54
#define FLAG_HIDE_ROCK_TUNNEL_1F_REPEL                          0xA55
#define FLAG_HIDE_ROCK_TUNNEL_1F_PEARL                          0xA56
#define FLAG_HIDE_ROCK_TUNNEL_1F_ESCAPE_ROPE                    0xA57
#define FLAG_HIDE_ROCK_TUNNEL_B1F_REVIVE                        0xA58
#define FLAG_HIDE_ROCK_TUNNEL_B1F_MAX_ETHER                     0xA59
#define FLAG_HIDE_SILPH_CO_8F_IRON                              0xA5A
#define FLAG_HIDE_SILPH_CO_11F_ZINC                             0xA5B
#define FLAG_HIDE_POKEMON_MANSION_1F_PROTEIN                    0xA5C
#define FLAG_HIDE_POKEMON_MANSION_2F_ZINC                       0xA5D
#define FLAG_HIDE_POKEMON_MANSION_2F_HP_UP                      0xA5E
#define FLAG_HIDE_VIRIDIAN_CITY_POTION                          0xA5F
#define FLAG_HIDE_ROUTE11_GREAT_BALL                            0xA60
#define FLAG_HIDE_ROUTE11_AWAKENING                             0xA61
#define FLAG_HIDE_POKEMON_TOWER_5F_CLEANSE_TAG                  0xA62
#define FLAG_HIDE_CELADON_CITY_ETHER                            0xA63
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_BLACK_GLASSES              0xA64
#define FLAG_HIDE_SAFARI_ZONE_NORTH_QUICK_CLAW                  0xA65
#define FLAG_HIDE_SEAFOAM_ISLANDS_1F_ICE_HEAL                   0xA66
#define FLAG_HIDE_SEAFOAM_ISLANDS_B1F_WATER_STONE               0xA67
#define FLAG_HIDE_SEAFOAM_ISLANDS_B1F_REVIVE                    0xA68
#define FLAG_HIDE_SEAFOAM_ISLANDS_B2F_BIG_PEARL                 0xA69
#define FLAG_HIDE_SEAFOAM_ISLANDS_B4F_ULTRA_BALL                0xA6A
#define FLAG_HIDE_FOUR_ISLAND_STAR_PIECE                        0xA6B
#define FLAG_HIDE_FOUR_ISLAND_STARDUST                          0xA6C
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_ETHER                  0xA6D
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_MAX_REPEL              0xA6E
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_CARBOS                 0xA6F
#define FLAG_HIDE_FIVE_ISLAND_MEADOW_MAX_POTION                 0xA70
#define FLAG_HIDE_FIVE_ISLAND_MEADOW_PP_UP                      0xA71
#define FLAG_HIDE_FIVE_ISLAND_MEMORIAL_PILLAR_METAL_COAT        0xA72
#define FLAG_HIDE_SIX_ISLAND_OUTCAST_ISLAND_PP_UP               0xA73
#define FLAG_HIDE_SIX_ISLAND_WATER_PATH_ELIXIR                  0xA74
#define FLAG_HIDE_SIX_ISLAND_WATER_PATH_DRAGON_SCALE            0xA75
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_FULL_RESTORE           0xA76
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_HP_UP                  0xA77
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_SUN_STONE              0xA78
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_KINGS_ROCK        0xA79
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_MAX_ELIXIR        0xA7A
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_NUGGET            0xA7B
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ETHER           0xA7C
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_FULL_HEAL           0xA7D
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ELIXIR          0xA7E
#define FLAG_HIDE_MT_EMBER_EXTERIOR_ULTRA_BALL                  0xA7F
#define FLAG_HIDE_MT_EMBER_EXTERIOR_FIRE_STONE                  0xA80
#define FLAG_HIDE_MT_EMBER_EXTERIOR_DIRE_HIT                    0xA81
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_ULTRA_BALL        0xA82
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_HM07              0xA83
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_FULL_RESTORE     0xA84
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_NEVER_MELT_ICE   0xA85
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_BIG_PEARL        0xA86
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_TM36             0xA87
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_PEARL            0xA88
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_UP_GRADE         0xA89
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM10_SILK_SCARF       0xA8A
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM11_LAX_INCENSE      0xA8B
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM12_SEA_INCENSE      0xA8C
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM13_MAX_REVIVE       0xA8D
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM14_RARE_CANDY       0xA8E
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_HOUSE_LUCKY_PUNCH 0xA8F
#define FLAG_HIDE_SILPH_CO_4F_TM41                              0xA90

// #define STORY_FLAGS_START                                0

#define FLAG_GOT_POTION_ON_ROUTE_1                       0xA91
#define FLAG_GOT_TM34_FROM_SURGE                         0xA92
#define FLAG_GOT_FOSSIL_FROM_MT_MOON                     0xA93
#define FLAG_HELPED_BILL_IN_SEA_COTTAGE                  0xA94
#define FLAG_GOT_SS_TICKET                               0xA95
#define FLAG_GOT_SS_TICKET_DUP                           0xA96
#define FLAG_GOT_TM42_AT_MEMORIAL_PILLAR                 0xA97
#define FLAG_GOT_HM01                                    0xA98
#define FLAG_GOT_HM02                                    0xA99
#define FLAG_GOT_HM03                                    0xA9A
#define FLAG_GOT_HM04                                    0xA9B
#define FLAG_GOT_HM05                                    0xA9C
#define FLAG_RESCUED_MR_FUJI                             0xA9D
#define FLAG_GOT_POKE_FLUTE                              0xA9E
#define FLAG_0x23E                                       0xA9G
#define FLAG_GOT_TM28_FROM_ROCKET                        0xAA0
#define FLAG_GOT_OLD_ROD                                 0xAA1
#define FLAG_GOT_BIKE_VOUCHER                            0xAA2
#define FLAG_0x242                                       0xAA3
#define FLAG_GOT_COIN_CASE                               0xAA4
#define FLAG_GOT_GOOD_ROD                                0xAA5
#define FLAG_GOT_TM29_FROM_MR_PSYCHIC                    0xAA6
#define FLAG_GOT_LAPRAS_FROM_SILPH                       0xAA7
#define FLAG_GOT_POKEBALLS_FROM_OAK_AFTER_22_RIVAL       0xAA8
#define FLAG_DID_MIMIEN_TRADE                            0xAA9
#define FLAG_BOUGHT_MAGIKARP                             0xAAA
#define FLAG_DID_ZYNX_TRADE                              0xAAB
#define FLAG_DID_MS_NIDO_TRADE                           0xAAC
#define FLAG_0x24C                                       0xAAD
#define FLAG_DID_CH_DING_TRADE                           0xAAE
#define FLAG_GOT_TM38_FROM_BLAINE                        0xAAF
#define FLAG_OAK_SKIP_22_RIVAL_CHECK                     0xAB0
#define FLAG_GOT_MASTER_BALL_FROM_SILPH                  0xAB1
#define FLAG_DID_NINA_TRADE                              0xAB2
#define FLAG_GOT_ITEMFINDER                              0xAB3
#define FLAG_WOKE_UP_ROUTE_12_SNORLAX                    0xAB4
#define FLAG_GOT_TM39_FROM_BROCK                         0xAB5
#define FLAG_GOT_SUPER_ROD                               0xAB6
#define FLAG_GOT_EXP_SHARE_FROM_OAKS_AIDE                0xAB7
#define FLAG_DID_MARC_TRADE                              0xAB8
#define FLAG_BEAT_RIVAL_IN_OAKS_LAB                      0xAB9
#define FLAG_GOT_TM06_FROM_KOGA                          0xABA
#define FLAG_0x25A                                       0xABB
#define FLAG_GOT_TM27                                    0xABC
#define FLAG_0x25C                                       0xABD
#define FLAG_0x25D                                       0xABE
#define FLAG_GOT_OLD_AMBER                               0xABF
#define FLAG_0x25F                                       0xAC0
#define FLAG_0x260                                       0xAC1
#define FLAG_0x261                                       0xAC2
#define FLAG_0x262                                       0xAC3
#define FLAG_GOT_EEVEE                                   0xAC4
#define FLAG_FOUND_BOTH_VERMILION_GYM_SWITCHES           0xAC5
#define FLAG_CINNABAR_GYM_QUIZ_1                         0xAC6
#define FLAG_CINNABAR_GYM_QUIZ_2                         0xAC7
#define FLAG_CINNABAR_GYM_QUIZ_3                         0xAC8
#define FLAG_CINNABAR_GYM_QUIZ_4                         0xAC9
#define FLAG_CINNABAR_GYM_QUIZ_5                         0xACA
#define FLAG_CINNABAR_GYM_QUIZ_6                         0xACB
#define FLAG_POKEMON_MANSION_SWITCH_STATE                0xACC
#define FLAG_OPENED_ROCKET_HIDEOUT                       0xACD
#define FLAG_GOT_10_COINS_FROM_GAMBLER                   0xACE
#define FLAG_GOT_20_COINS_FROM_GAMBLER                   0xACF
#define FLAG_GOT_20_COINS_FROM_GAMBLER_2                 0xAD0
#define FLAG_GOT_BICYCLE                                 0xAD1
#define FLAG_GOT_DOME_FOSSIL                             0xAD2
#define FLAG_GOT_HELIX_FOSSIL                            0xAD3
#define FLAG_DID_ESPHERE_TRADE                           0xAD4
#define FLAG_DID_TANGENY_TRADE                           0xAD5
#define FLAG_DID_SEELOR_TRADE                            0xAD6
#define FLAG_0x277                                       0xAD7
#define FLAG_GOT_HITMON_FROM_DOJO                        0xAD8
#define FLAG_0x279                                       0xAD9
#define FLAG_SILPH_2F_DOOR_1                             0xADA
#define FLAG_SILPH_2F_DOOR_2                             0xADB
#define FLAG_SILPH_3F_DOOR_1                             0xADC
#define FLAG_SILPH_3F_DOOR_2                             0xADD
#define FLAG_SILPH_4F_DOOR_1                             0xADE
#define FLAG_SILPH_4F_DOOR_2                             0xADF
#define FLAG_SILPH_5F_DOOR_1                             0xAE0
#define FLAG_SILPH_5F_DOOR_2                             0xAE1
#define FLAG_SILPH_5F_DOOR_3                             0xAE2
#define FLAG_SILPH_6F_DOOR                               0xAE3
#define FLAG_SILPH_7F_DOOR_1                             0xAE4
#define FLAG_SILPH_7F_DOOR_2                             0xAE5
#define FLAG_SILPH_7F_DOOR_3                             0xAE6
#define FLAG_SILPH_8F_DOOR                               0xAE7
#define FLAG_SILPH_9F_DOOR_1                             0xAE8
#define FLAG_SILPH_9F_DOOR_2                             0xAE9
#define FLAG_SILPH_9F_DOOR_3                             0xAEA
#define FLAG_SILPH_9F_DOOR_4                             0xAEB
#define FLAG_SILPH_10F_DOOR                              0xAEC
#define FLAG_SILPH_11F_DOOR                              0xAED
#define FLAG_0x28E                                       0xAEE
#define FLAG_0x28F                                       0xAEF
#define FLAG_MET_STICKER_MAN                             0xAF0
#define FLAG_PALLET_LADY_NOT_BLOCKING_SIGN               0xAF1
#define FLAG_GOT_VS_SEEKER                               0xAF2
#define FLAG_GOT_TM19_FROM_ERIKA                         0xAF3
#define FLAG_GOT_TM33_FROM_THIRSTY_GIRL                  0xAF4
#define FLAG_GOT_TM20_FROM_THIRSTY_GIRL                  0xAF5
#define FLAG_GOT_TM16_FROM_THIRSTY_GIRL                  0xAF6
#define FLAG_GOT_TM03_FROM_MISTY                         0xAF7
#define FLAG_GOT_TM26_FROM_GIOVANNI                      0xAF8
#define FLAG_0x299                                       0xAF9
#define FLAG_GOT_TM04_FROM_SABRINA                       0xAFA
#define FLAG_GOT_FAME_CHECKER                            0xAFB
#define FLAG_GOT_RECORD_SETTING_MAGIKARP                 0xAFC
#define FLAG_TWO_ISLAND_SHOP_INTRODUCED                  0xAFD
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_1                  0xAFE
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_2                  0xAFF
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_3                  0xB00
#define FLAG_SEVII_DETOUR_FINISHED                       0xB01
#define FLAG_VISITED_TWO_ISLAND                          0xB02
#define FLAG_RESCUED_LOSTELLE                            0xB03
#define FLAG_0x2A4                                       0xB04
#define FLAG_CAN_USE_ROCKET_HIDEOUT_LIFT                 0xB05
#define FLAG_GOT_TEA                                     0xB06
#define FLAG_GOT_POWDER_JAR                              0xB07
#define FLAG_FOUGHT_MEWTWO                               0xB08
#define FLAG_FOUGHT_MOLTRES                              0xB09
#define FLAG_FOUGHT_ARTICUNO                             0xB0A
#define FLAG_FOUGHT_ZAPDOS                               0xB0B
#define FLAG_TUTOR_DOUBLE_EDGE                           0xB0C
#define FLAG_TUTOR_THUNDER_WAVE                          0xB0D
#define FLAG_TUTOR_ROCK_SLIDE                            0xB0E
#define FLAG_TUTOR_EXPLOSION                             0xB0F
#define FLAG_TUTOR_MEGA_PUNCH                            0xB10
#define FLAG_TUTOR_MEGA_KICK                             0xB11
#define FLAG_TUTOR_DREAM_EATER                           0xB13
#define FLAG_TUTOR_SOFT_BOILED                           0xB14
#define FLAG_TUTOR_SUBSTITUTE                            0xB15
#define FLAG_TUTOR_SWORDS_DANCE                          0xB16
#define FLAG_TUTOR_SEISMIC_TOSS                          0xB17
#define FLAG_TUTOR_COUNTER                               0xB18
#define FLAG_TUTOR_METRONOME                             0xB19
#define FLAG_TUTOR_MIMIC                                 0xB1A
#define FLAG_TUTOR_BODY_SLAM                             0xB1B
#define FLAG_VISITED_OAKS_LAB                            0xB1C
#define FLAG_FOUGHT_POWER_PLANT_ELECTRODE_1              0xB1D
#define FLAG_FOUGHT_POWER_PLANT_ELECTRODE_2              0xB1E
#define FLAG_STOPPED_SEAFOAM_B3F_CURRENT                 0xB1F
#define FLAG_STOPPED_SEAFOAM_B4F_CURRENT                 0xB20
#define FLAG_TALKED_TO_LORELEI_AFTER_WAREHOUSE           0xB21
#define FLAG_DEFEATED_ROCKETS_IN_WAREHOUSE               0xB22
#define FLAG_UNLOCKED_ROCKET_WAREHOUSE                   0xB23
#define FLAG_NO_ROOM_FOR_TM42_AT_MEMORIAL_PILLAR         0xB24
#define FLAG_LEARNED_YES_NAH_CHANSEY                     0xB25
#define FLAG_GOT_NEST_BALL_FROM_WATER_PATH_HOUSE_1       0xB26
#define FLAG_GOT_TOGEPI_EGG                              0xB27
#define FLAG_NO_ROOM_FOR_TOGEPI_EGG                      0xB28
#define FLAG_RECOVERED_SAPPHIRE                          0xB29
#define FLAG_GOT_RUBY                                    0xB2A
#define FLAG_TUTOR_FRENZY_PLANT                          0xB2B
#define FLAG_TUTOR_BLAST_BURN                            0xB2C
#define FLAG_TUTOR_HYDRO_CANNON                          0xB2D
#define FLAG_LEARNED_ALL_MOVES_AT_CAPE_BRINK             0xB2E
#define FLAG_GOT_NUGGET_FROM_DUNSPARCE_TUNNEL            0xB2F
#define FLAG_USED_CUT_ON_RUIN_VALLEY_BRAILLE             0xB30
#define FLAG_FOUGHT_DEOXYS                               0xB31
#define FLAG_0x2E5                                       0xB32
#define FLAG_0x2E6                                       0xB33
#define FLAG_0x2E7                                       0xB34
#define FLAG_0x2E8                                       0xB35
#define FLAG_0x2E9                                       0xB36
#define FLAG_0x2EA                                       0xB37
#define FLAG_0x2EB                                       0xB38
#define FLAG_REVIVED_DOME                                0xB39
#define FLAG_REVIVED_HELIX                               0xB3A
#define FLAG_REVIVED_AMBER                               0xB3B
#define FLAG_GOT_HM06                                    0xB3C
#define FLAG_FOUGHT_LUGIA                                0xB3D
#define FLAG_FOUGHT_HO_OH                                0xB3E
#define FLAG_OAK_SAW_DEX_COMPLETION                      0xB3F
#define FLAG_LUGIA_FLEW_AWAY                             0xB40
#define FLAG_HO_OH_FLEW_AWAY                             0xB41
#define FLAG_DEOXYS_FLEW_AWAY                            0xB42
#define FLAG_TALKED_TO_TEA_LADY_AFTER_HOF                0xB43
#define FLAG_TALKED_TO_OAKS_AIDE_IN_VERMILION            0xB44
#define FLAG_GOT_EVERSTONE_FROM_OAKS_AIDE                0xB45
#define FLAG_GOT_MOON_STONE_FROM_JOYFUL_GAME_CORNER      0xB46
#define FLAG_GOT_FULL_RESTORE_FROM_THREE_ISLAND_DEFENDER 0xB47
#define FLAG_GOT_AMULET_COIN_FROM_OAKS_AIDE              0xB48
#define FLAG_NO_ROOM_FOR_JOYFUL_GAME_CORNER_MOON_STONE   0xB49
#define FLAG_OAKS_RATING_IS_VIA_PC                       0xB4A

#define FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_POTION                            0xB4B
#define FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_ANTIDOTE                          0xB4C
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_MOON_STONE                            0xB4D
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_ETHER                                 0xB4E
#define FLAG_HIDDEN_ITEM_ROUTE25_ELIXIR                                    0xB4F
#define FLAG_HIDDEN_ITEM_ROUTE25_ETHER                                     0xB50
#define FLAG_HIDDEN_ITEM_ROUTE9_ETHER                                      0xB51
#define FLAG_HIDDEN_ITEM_UNUSED_0x07                                       0xB52
#define FLAG_HIDDEN_ITEM_SSANNE_B1F_CORRIDOR_HYPER_POTION                  0xB53
#define FLAG_HIDDEN_ITEM_ROUTE10_SUPER_POTION                              0xB54
#define FLAG_HIDDEN_ITEM_ROUTE10_MAX_ETHER                                 0xB55
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B1F_PP_UP                          0xB56
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B3F_NUGGET                         0xB57
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NEST_BALL                      0xB58
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_5F_BIG_MUSHROOM                     0xB59
#define FLAG_HIDDEN_ITEM_ROUTE13_PP_UP                                     0xB5A
#define FLAG_HIDDEN_ITEM_UNUSED_0x10                                       0xB5B
#define FLAG_HIDDEN_ITEM_ROUTE17_RARE_CANDY                                0xB5C
#define FLAG_HIDDEN_ITEM_ROUTE17_FULL_RESTORE                              0xB5D
#define FLAG_HIDDEN_ITEM_ROUTE17_PP_UP                                     0xB5E
#define FLAG_HIDDEN_ITEM_ROUTE17_MAX_REVIVE                                0xB5F
#define FLAG_HIDDEN_ITEM_ROUTE17_MAX_ELIXIR                                0xB60
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_CENTER_LEAF_STONE                     0xB61
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_WEST_REVIVE                           0xB62
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_ELIXIR                                0xB63
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_MAX_POTION                            0xB64
#define FLAG_HIDDEN_ITEM_SAFFRON_CITY_COPYCATS_HOUSE_2F_NUGGET             0xB65
#define FLAG_HIDDEN_ITEM_POWER_PLANT_MAX_ELIXIR                            0xB66
#define FLAG_HIDDEN_ITEM_POWER_PLANT_THUNDER_STONE                         0xB67
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B3F_NUGGET                        0xB68
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B4F_WATER_STONE                   0xB69
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_1F_MOON_STONE                     0xB6A
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_3F_RARE_CANDY                     0xB6B
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_B1F_ELIXIR                        0xB6C
#define FLAG_HIDDEN_ITEM_ROUTE23_FULL_RESTORE                              0xB6D
#define FLAG_HIDDEN_ITEM_ROUTE23_ULTRA_BALL                                0xB6E
#define FLAG_HIDDEN_ITEM_ROUTE23_MAX_ETHER                                 0xB6F
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_FULL_RESTORE                      0xB70
#define FLAG_HIDDEN_ITEM_CERULEAN_CAVE_1F_ULTRA_BALL                       0xB71
#define FLAG_HIDDEN_ITEM_UNUSED_0x28                                       0xB72
#define FLAG_HIDDEN_ITEM_ROUTE11_ESCAPE_ROPE                               0xB73
#define FLAG_HIDDEN_ITEM_ROUTE12_HYPER_POTION                              0xB74
#define FLAG_HIDDEN_ITEM_UNUSED_0x2B                                       0xB75
#define FLAG_HIDDEN_ITEM_UNUSED_0x2C                                       0xB76
#define FLAG_HIDDEN_ITEM_UNUSED_0x2D                                       0xB77
#define FLAG_HIDDEN_ITEM_UNUSED_0x2E                                       0xB78
#define FLAG_HIDDEN_ITEM_CELADON_CITY_PP_UP                                0xB79
#define FLAG_HIDDEN_ITEM_VERMILION_CITY_MAX_ETHER                          0xB7A
#define FLAG_HIDDEN_ITEM_CERULEAN_CITY_RARE_CANDY                          0xB7B
#define FLAG_HIDDEN_ITEM_ROUTE4_GREAT_BALL                                 0xB7C
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS                    0xB7D
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_2                  0xB7E
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_3                  0xB7F
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_4                  0xB80
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_5                  0xB81
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_6                  0xB82
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_7                  0xB83
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_8                  0xB84
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_9                  0xB85
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_10                 0xB86
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_11                 0xB87
#define FLAG_HIDDEN_ITEM_CELADON_CITY_GAME_CORNER_COINS_12                 0xB88
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_CHERI_BERRY           0xB89
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_4           0xB8A
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE             0xB8B
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_2           0xB8C
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_3           0xB8D
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NEST_BALL            0xB8E
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NET_BALL             0xB8F
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_POTION        0xB90
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ANTIDOTE      0xB91
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_PARALYZE_HEAL 0xB92
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_AWAKENING     0xB93
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_BURN_HEAL     0xB94
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ICE_HEAL      0xB95
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ETHER         0xB96
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_POTION          0xB97
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ANTIDOTE        0xB98
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_PARALYZE_HEAL   0xB99
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_AWAKENING       0xB9A
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_BURN_HEAL       0xB9B
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ICE_HEAL        0xB9C
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ETHER           0xB9D
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM                         0xB9E
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_2                       0xB9F
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_3                       0xBA0
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM                          0xBA1
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_2                        0xBA2
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_3                        0xBA3
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAZZ_BERRY              0xBA4
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_BLUK_BERRY              0xBA5
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_NANAB_BERRY             0xBA6
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WEPEAR_BERRY            0xBA7
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ORAN_BERRY              0xBA8
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHERI_BERRY             0xBA9
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY            0xBAA
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY             0xBAB
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY             0xBAC
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ASPEAR_BERRY            0xBAD
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY            0xBAE
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PINAP_BERRY             0xBAF
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_LUM_BERRY               0xBB0
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST                0xBB1
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST_2              0xBB2
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL                   0xBB3
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL_2                 0xBB4
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL              0xBB5
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL_2            0xBB6
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STAR_PIECE              0xBB7
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BIG_PEARL               0xBB8
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_RARE_CANDY                  0xBB9
#define FLAG_HIDDEN_ITEM_PEWTER_CITY_POKE_BALL                             0xBBA
#define FLAG_HIDDEN_ITEM_ROUTE3_ORAN_BERRY                                 0xBBB
#define FLAG_HIDDEN_ITEM_ROUTE4_PERSIM_BERRY                               0xBBC
#define FLAG_HIDDEN_ITEM_ROUTE24_PECHA_BERRY                               0xBBD
#define FLAG_HIDDEN_ITEM_ROUTE25_ORAN_BERRY                                0xBBE
#define FLAG_HIDDEN_ITEM_ROUTE25_BLUK_BERRY                                0xBBF
#define FLAG_HIDDEN_ITEM_ROUTE6_SITRUS_BERRY                               0xBC0
#define FLAG_HIDDEN_ITEM_ROUTE6_RARE_CANDY                                 0xBC1
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_PECHA_BERRY                        0xBC2
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHERI_BERRY                        0xBC3
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHESTO_BERRY                       0xBC4
#define FLAG_HIDDEN_ITEM_ROUTE9_RARE_CANDY                                 0xBC5
#define FLAG_HIDDEN_ITEM_UNUSED_0x7C                                       0xBC6
#define FLAG_HIDDEN_ITEM_ROUTE10_PERSIM_BERRY                              0xBC7
#define FLAG_HIDDEN_ITEM_ROUTE10_CHERI_BERRY                               0xBC8
#define FLAG_HIDDEN_ITEM_ROUTE8_RAWST_BERRY                                0xBC9
#define FLAG_HIDDEN_ITEM_ROUTE8_LUM_BERRY                                  0xBCA
#define FLAG_HIDDEN_ITEM_ROUTE8_LEPPA_BERRY                                0xBCB
#define FLAG_HIDDEN_ITEM_ROUTE12_RARE_CANDY                                0xBCC
#define FLAG_HIDDEN_ITEM_ROUTE12_LEFTOVERS                                 0xBCD
#define FLAG_HIDDEN_ITEM_ROUTE16_LEFTOVERS                                 0xBCE
#define FLAG_HIDDEN_ITEM_FUCHSIA_CITY_MAX_REVIVE                           0xBCF
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NET_BALL                       0xBD0
#define FLAG_HIDDEN_ITEM_SILPH_CO_2F_ULTRA_BALL                            0xBD1
#define FLAG_HIDDEN_ITEM_SILPH_CO_3F_PROTEIN                               0xBD2
#define FLAG_HIDDEN_ITEM_SILPH_CO_4F_IRON                                  0xBD3
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_PP_UP                                 0xBD4
#define FLAG_HIDDEN_ITEM_SILPH_CO_6F_CARBOS                                0xBD5
#define FLAG_HIDDEN_ITEM_SILPH_CO_7F_ZINC                                  0xBD6
#define FLAG_HIDDEN_ITEM_SILPH_CO_8F_NUGGET                                0xBD7
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_CALCIUM                               0xBD8
#define FLAG_HIDDEN_ITEM_SILPH_CO_10F_HP_UP                                0xBD9
#define FLAG_HIDDEN_ITEM_SILPH_CO_11F_REVIVE                               0xBDA
#define FLAG_HIDDEN_ITEM_ROUTE23_LUM_BERRY                                 0xBDB
#define FLAG_HIDDEN_ITEM_ROUTE23_SITRUS_BERRY                              0xBDC
#define FLAG_HIDDEN_ITEM_ROUTE23_ASPEAR_BERRY                              0xBDD
#define FLAG_HIDDEN_ITEM_ROUTE23_LEPPA_BERRY                               0xBDE
#define FLAG_HIDDEN_ITEM_ROUTE14_ZINC                                      0xBDF
#define FLAG_HIDDEN_ITEM_ROUTE9_CHESTO_BERRY                               0xBE0
#define FLAG_HIDDEN_ITEM_ROUTE10_NANAB_BERRY                               0xBE1
#define FLAG_HIDDEN_ITEM_ROUTE7_WEPEAR_BERRY                               0xBE2
#define FLAG_HIDDEN_ITEM_ROUTE20_STARDUST                                  0xBE3
#define FLAG_HIDDEN_ITEM_ROUTE21_NORTH_PEARL                               0xBE4
#define FLAG_HIDDEN_ITEM_ROUTE23_MAX_ELIXIR                                0xBE5
#define FLAG_HIDDEN_ITEM_ROUTE4_RAZZ_BERRY                                 0xBE6
#define FLAG_HIDDEN_ITEM_ROUTE14_PINAP_BERRY                               0xBE7
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_FIRE_STONE                      0xBE8
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_7F_SOOTHE_BELL                      0xBE9
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_SUMMIT_SACRED_ASH                      0xBEA
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_PP_MAX                      0xBEB
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_ULTRA_BALL                      0xBEC
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_DUNSPARCE_TUNNEL_NUGGET              0xBED
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_PP_UP                                0xBEE
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_MAX_REPEL                0xBEF
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_PEARL                    0xBF0
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_STARDUST                 0xBF1
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_PEARL                                 0xBF2
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_ULTRA_BALL                            0xBF3
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BIG_PEARL             0xBF4
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_RAZZ_BERRY            0xBF5
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_SITRUS_BERRY          0xBF6
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BLUK_BERRY            0xBF7
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_NEST_BALL             0xBF8
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST              0xBF9
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STAR_PIECE            0xBFA
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST_2            0xBFB
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_STAR_PIECE              0xBFC
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_NET_BALL                0xBFD
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_GREEN_PATH_ULTRA_BALL                  0xBFE
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ASPEAR_BERRY                0xBFF
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ORAN_BERRY                  0xC00
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_PINAP_BERRY                 0xC01
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_LEPPA_BERRY                            0xC02
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_BIG_PEARL              0xC03
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_PEARL                  0xC04
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_NANAB_BERRY            0xC05
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE_RAWST_BERRY  0xC06
#define FLAG_HIDDEN_ITEM_VIRIDIAN_CITY_GYM_MACHO_BRACE                     0xC07
#define FLAG_HIDDEN_ITEM_SSANNE_EXTERIOR_LAVA_COOKIE                       0xC08

#define FLAG_DEFEATED_BROCK           0xC09
#define FLAG_DEFEATED_MISTY           0xC0A
#define FLAG_DEFEATED_LT_SURGE        0xC0B
#define FLAG_DEFEATED_ERIKA           0xC0C
#define FLAG_DEFEATED_KOGA            0xC0D
#define FLAG_DEFEATED_SABRINA         0xC0E
#define FLAG_DEFEATED_BLAINE          0xC0F
#define FLAG_DEFEATED_LEADER_GIOVANNI 0xC10
#define FLAG_DEFEATED_LORELEI         0xC11
#define FLAG_DEFEATED_BRUNO           0xC12
#define FLAG_DEFEATED_AGATHA          0xC13
#define FLAG_DEFEATED_LANCE           0xC14
#define FLAG_DEFEATED_CHAMP           0xC15

#define FLAG_0x82A                                                  0xC16
#define FLAG_0x82B                                                  0xC17
#define FLAG_SYS_SET_TRAINER_CARD_PROFILE                           0XC18
#define FLAG_0x82E                                                  0xC19
#define FLAG_SYS_ON_CYCLING_ROAD                                    0xC1A
#define FLAG_0x831                                                  0xC1B
#define FLAG_0x832                                                  0xC1C
#define FLAG_0x833                                                  0xC1D
#define FLAG_0x835                                                  0xC1E
#define FLAG_0x836                                                  0xC1F
#define FLAG_0x838                                                  0xC20 // Set, never read
#define FLAG_0x83A                                                  0xC21
#define FLAG_SYS_SAW_HELP_SYSTEM_INTRO                              0xC22
#define FLAG_0x83D                                                  0xC23
#define FLAG_OPENED_START_MENU                                      0xC24
#define FLAG_SYS_PC_STORAGE_DISABLED                                0xC25
#define FLAG_SYS_SEVII_MAP_123                                      0xC26
#define FLAG_SYS_SEVII_MAP_4567                                     0xC27
#define FLAG_SYS_GOT_BERRY_POUCH                                    0xC28
#define FLAG_SYS_UNLOCKED_TANOBY_RUINS                              0xC29

// Flight Call item scripts
#define FLAG_GOT_FLIGHT_CALL                                        0xC2A        //Teleport Item
#define FLAG_HIDE_ROUTE_PROF_ASSISTANT                              0xC2B

// World Map Flags
#define FLAG_WORLD_MAP_PALLET_TOWN                                  0xC2C
#define FLAG_WORLD_MAP_VIRIDIAN_CITY                                0xC2D
#define FLAG_WORLD_MAP_PEWTER_CITY                                  0xC2E
#define FLAG_WORLD_MAP_CERULEAN_CITY                                0xC2F
#define FLAG_WORLD_MAP_LAVENDER_TOWN                                0xC30
#define FLAG_WORLD_MAP_VERMILION_CITY                               0xC31
#define FLAG_WORLD_MAP_CELADON_CITY                                 0xC32
#define FLAG_WORLD_MAP_FUCHSIA_CITY                                 0xC33
#define FLAG_WORLD_MAP_CINNABAR_ISLAND                              0xC34
#define FLAG_WORLD_MAP_INDIGO_PLATEAU_EXTERIOR                      0xC35
#define FLAG_WORLD_MAP_SAFFRON_CITY                                 0xC36
#define FLAG_WORLD_MAP_ONE_ISLAND                                   0xC37
#define FLAG_WORLD_MAP_TWO_ISLAND                                   0xC38
#define FLAG_WORLD_MAP_THREE_ISLAND                                 0xC39
#define FLAG_WORLD_MAP_FOUR_ISLAND                                  0xC3A
#define FLAG_WORLD_MAP_FIVE_ISLAND                                  0xC3B
#define FLAG_WORLD_MAP_SEVEN_ISLAND                                 0xC3C
#define FLAG_WORLD_MAP_SIX_ISLAND                                   0xC3D
#define FLAG_WORLD_MAP_ROUTE4_POKEMON_CENTER_1F                     0xC3E
#define FLAG_WORLD_MAP_ROUTE10_POKEMON_CENTER_1F                    0xC3F
#define FLAG_WORLD_MAP_VIRIDIAN_FOREST                              0xC40
#define FLAG_WORLD_MAP_MT_MOON_1F                                   0xC41
#define FLAG_WORLD_MAP_SSANNE_EXTERIOR                              0xC42
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL          0xC43
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL            0xC44
#define FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F                            0xC45
#define FLAG_WORLD_MAP_VICTORY_ROAD_1F                              0xC46
#define FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F                           0xC47
#define FLAG_WORLD_MAP_SILPH_CO_1F                                  0xC48
#define FLAG_WORLD_MAP_POKEMON_MANSION_1F                           0xC49
#define FLAG_WORLD_MAP_SAFARI_ZONE_CENTER                           0xC4A
#define FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM                 0xC4B
#define FLAG_WORLD_MAP_ROCK_TUNNEL_1F                               0xC4C
#define FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F                           0xC4D
#define FLAG_WORLD_MAP_POKEMON_TOWER_1F                             0xC4E
#define FLAG_WORLD_MAP_CERULEAN_CAVE_1F                             0xC4F
#define FLAG_WORLD_MAP_POWER_PLANT                                  0xC50
#define FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR                          0xC51
#define FLAG_WORLD_MAP_MT_EMBER_EXTERIOR                            0xC52
#define FLAG_WORLD_MAP_THREE_ISLAND_BERRY_FOREST                    0xC53
#define FLAG_WORLD_MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE            0xC54
#define FLAG_WORLD_MAP_FIVE_ISLAND_ROCKET_WAREHOUSE                 0xC55
#define FLAG_WORLD_MAP_TRAINER_TOWER_LOBBY                          0xC56
#define FLAG_WORLD_MAP_SIX_ISLAND_DOTTED_HOLE_1F                    0xC57
#define FLAG_WORLD_MAP_FIVE_ISLAND_LOST_CAVE_ENTRANCE               0xC58
#define FLAG_WORLD_MAP_SIX_ISLAND_PATTERN_BUSH                      0xC59
#define FLAG_WORLD_MAP_SIX_ISLAND_ALTERING_CAVE                     0xC5A
#define FLAG_WORLD_MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER     0xC5B
#define FLAG_WORLD_MAP_THREE_ISLAND_DUNSPARCE_TUNNEL                0xC5C
#define FLAG_WORLD_MAP_SEVEN_ISLAND_SEVAULT_CANYON_TANOBY_KEY       0xC5D
#define FLAG_WORLD_MAP_BIRTH_ISLAND_EXTERIOR                        0xC5E

#define FLAG_HIDE_SILPH_SCOPE                                       0xC5F
#define FLAG_HIDE_LIFT_KEY                                          0xC60
#define FLAG_HIDE_TOWER_FUJI                                        0xC61
#define FLAG_HIDE_POKEHOUSE_FUJI                                    0xC62

#define FLAGS_COUNT 								(FLAG_HIDE_POKEHOUSE_FUJI + 1)

...
#define FLAG_SYS_EXP_SHARE_FLAG                     (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_SYS_VS_SEEKER_CHARGING                 (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_SYS_PAUSE_TIME                         (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_SYS_NO_ENCOUNTER                       (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_SYS_NO_TRAINER_SEE                     (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_SYS_NO_COLLISION                       (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_SYS_FORCE_SHINY                        (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_SYS_FORCE_NO_SHINY                     (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_SYS_INVERSE_BATTLE                     (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_SYS_FORCE_DOUBLE_WILD                  (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_SYS_SMART_WILD_AI_FLAG                 (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_SYS_NO_BAG_USE                         (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_SYS_NO_CATCHING                        (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_SYS_AI_VS_AI_BATTLE                    (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_SYS_DYNAMAX_BATTLE                     (SYSTEM_FLAGS + 0x93) // Unused Flag
...
#define FLAG_SYS_NO_RUNNING                         (SYSTEM_FLAGS + 0x98) // Unused Flag

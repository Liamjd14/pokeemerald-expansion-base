...
#define FLAG_SYS_OW_NO_COLLISION                    (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_SYS_OW_POKE_RIDER                      (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_SYS_OW_UNION_ROOM                      (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_SYS_I_EXP_SHARE                        (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_SYS_I_VS_SEEKER                        (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_SYS_FOLLOWER_HEAL                      (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_SYS_FOLLOWER_WILD                      (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_SYS_DN_SEARCHING                       (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_SYS_DN_DEXNAV_GET                      (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_SYS_DN_DETECTOR_MODE                   (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_SYS_B_INVERSE_BATTLE                   (SYSTEM_FLAGS + 0x95) // Unused Flag
#define FLAG_SYS_B_FORCE_WILD_DOUBLE                (SYSTEM_FLAGS + 0x96) // Unused Flag
#define FLAG_SYS_B_SMART_WILD_AI                    (SYSTEM_FLAGS + 0x97) // Unused Flag
#define FLAG_SYS_B_NO_BAG                           (SYSTEM_FLAGS + 0x98) // Unused Flag
#define FLAG_SYS_B_NO_CATCHING                      (SYSTEM_FLAGS + 0x99) // Unused Flag
#define FLAG_SYS_B_NO_RUNNING                       (SYSTEM_FLAGS + 0x9A) // Unused Flag
#define FLAG_SYS_B_AI_BATTLE                        (SYSTEM_FLAGS + 0x9B) // Unused Flag
#define FLAG_SYS_B_DYNAMAX_BATTLE                   (SYSTEM_FLAGS + 0x9C) // Unused Flag
#define FLAG_SYS_B_TERA_ORB_CHARGED                 (SYSTEM_FLAGS + 0x9D) // Unused Flag
#define FLAG_SYS_B_TERA_ORB_NO_CHARGE               (SYSTEM_FLAGS + 0x9E) // Unused Flag
#define FLAG_SYS_B_SLEEP_CLAUSE                     (SYSTEM_FLAGS + 0x9F) // Unused Flag

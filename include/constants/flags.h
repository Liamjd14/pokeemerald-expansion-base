...
#define FLAG_CAUGHT_UXIE    0x28 // Unused Flag
#define FLAG_CAUGHT_AZELF    0x29 // Unused Flag
#define FLAG_CAUGHT_MESPIRT    0x2A // Unused Flag
#define FLAG_CAN_TRANSLATE_GLYPHS    0x2B // Unused Flag
#define FLAG_NORMAL_PC    0x2C // Unused Flag
#define FLAG_FIGHTING_PC    0x2D // Unused Flag
#define FLAG_FIRE_PC    0x2E // Unused Flag
#define FLAG_DRAGON_PC    0x2F // Unused Flag
#define FLAG_DARK_PC    0x30 // Unused Flag
#define FLAG_ELECTRIC_PC    0x31 // Unused Flag
#define FLAG_POISON_PC    0x32 // Unused Flag
#define FLAG_ICE_PC    0x33 // Unused Flag
#define FLAG_WATER_PC    0x34 // Unused Flag
#define FLAG_BUG_PC    0x35 // Unused Flag
#define FLAG_GRASS_PC    0x36 // Unused Flag
#define FLAG_GROUND_PC    0x37 // Unused Flag
#define FLAG_ROCK_PC    0x38 // Unused Flag
#define FLAG_STEEL_PC    0x39 // Unused Flag
#define FLAG_PSYCHIC_PC    0x3A // Unused Flag
#define FLAG_GHOST_PC    0x3B // Unused Flag
#define FLAG_FLYING_PC    0x3C // Unused Flag
#define FLAG_FAIRY_PC    0x3D // Unused Flag
#define FLAG_NORMAL_PC1    0x3E // Unused Flag
#define FLAG_FIGHTING_PC1    0x3F // Unused Flag
#define FLAG_FIRE_PC1    0x40 // Unused Flag
#define FLAG_DRAGON_PC1    0x41 // Unused Flag
#define FLAG_DARK_PC1    0x42 // Unused Flag
#define FLAG_ELECTRIC_PC1    0x43 // Unused Flag
#define FLAG_POISON_PC1    0x44 // Unused Flag
#define FLAG_ICE_PC1    0x45 // Unused Flag
#define FLAG_WATER_PC1    0x46 // Unused Flag
#define FLAG_BUG_PC1    0x47 // Unused Flag
#define FLAG_GRASS_PC1    0x48 // Unused Flag
#define FLAG_GROUND_PC1    0x49 // Unused Flag
#define FLAG_ROCK_PC1    0x4A // Unused Flag
#define FLAG_STEEL_PC1    0x4B // Unused Flag
#define FLAG_PSYCHIC_PC1    0x4C // Unused Flag
#define FLAG_GHOST_PC1    0x4D // Unused Flag
#define FLAG_FLYING_PC1    0x4E // Unused Flag
#define FLAG_FAIRY_PC1    0x4F // Unused Flag
...
#define FLAG_HIDDEN_ITEM_NORMAL_GEM  0x297 // Unused Flag
#define FLAG_HIDDEN_ITEM_FIGHTING_GEM  0x298 // Unused Flag
#define FLAG_HIDDEN_ITEM_BUG_GEM  0x299 // Unused Flag
#define FLAG_HIDDEN_ITEM_FIRE_GEM  0x29A // Unused Flag
#define FLAG_HIDDEN_ITEM_WATER_GEM  0x29B // Unused Flag
#define FLAG_HIDDEN_ITEM_GRASS_GEM  0x29C // Unused Flag
#define FLAG_HIDDEN_ITEM_ELETRIC_GEM  0x29D // Unused Flag
#define FLAG_HIDDEN_ITEM_FLYING_GEM  0x29E // Unused Flag
#define FLAG_HIDDEN_ITEM_GHOST_GEM  0x29F // Unused Flag
#define FLAG_HIDDEN_ITEM_DARK_GEM  0x2A0 // Unused Flag
#define FLAG_HIDDEN_ITEM_PSYCHIC_GEM  0x2A1 // Unused Flag
#define FLAG_HIDDEN_ITEM_ROCK_GEM  0x2A2 // Unused Flag
#define FLAG_HIDDEN_ITEM_GROUND_GEM  0x2A3 // Unused Flag
#define FLAG_HIDDEN_ITEM_STEEL_GEM  0x2A4 // Unused Flag
#define FLAG_HIDDEN_ITEM_DRAGON_GEM  0x2A5 // Unused Flag
#define FLAG_HIDDEN_ITEM_FAIRY_GEM  0x2A6 // Unused Flag
#define FLAG_HIDDEN_ITEM_POISON_GEM  0x2A7 // Unused Flag
#define FLAG_HIDDEN_ITEM_ICE_GEM  0x2A8 // Unused Flag
#define FLAG_HIDDEN_ITEM_NORMAL_TERA_SHARD  0x2A9 // Unused Flag
#define FLAG_HIDDEN_ITEM_FIGHTING_TERA_SHARD  0x2AA // Unused Flag
#define FLAG_HIDDEN_ITEM_BUG_TERA_SHARD  0x2AB // Unused Flag
#define FLAG_HIDDEN_ITEM_FIRE_TERA_SHARD  0x2AC // Unused Flag
#define FLAG_HIDDEN_ITEM_WATER_TERA_SHARD  0x2AD // Unused Flag
#define FLAG_HIDDEN_ITEM_GRASS_TERA_SHARD  0x2AE // Unused Flag
#define FLAG_HIDDEN_ITEM_ELETRIC_TERA_SHARD  0x2AF // Unused Flag
#define FLAG_HIDDEN_ITEM_FLYING_TERA_SHARD  0x2B0 // Unused Flag
#define FLAG_HIDDEN_ITEM_GHOST_TERA_SHARD  0x2B1 // Unused Flag
#define FLAG_HIDDEN_ITEM_DARK_TERA_SHARD  0x2B2 // Unused Flag
#define FLAG_HIDDEN_ITEM_PSYCHIC_TERA_SHARD  0x2B3 // Unused Flag
#define FLAG_HIDDEN_ITEM_ROCK_TERA_SHARD  0x2B4 // Unused Flag
#define FLAG_HIDDEN_ITEM_GROUND_TERA_SHARD  0x2B5 // Unused Flag
#define FLAG_HIDDEN_ITEM_STEEL_TERA_SHARD  0x2B6 // Unused Flag
#define FLAG_HIDDEN_ITEM_DRAGON_TERA_SHARD  0x2B7 // Unused Flag
#define FLAG_HIDDEN_ITEM_FAIRY_TERA_SHARD  0x2B8 // Unused Flag
#define FLAG_HIDDEN_ITEM_POISON_TERA_SHARD  0x2B9 // Unused Flag
#define FLAG_HIDDEN_ITEM_ICE_TERA_SHARD  0x2BA // Unused Flag
#define FLAG_HIDDEN_ITEM_STELLAR_TERA_SHARD  0x2BB // Unused Flag
// hidden item end
...
// Custom System Flags
#define FLAG_P_FORCE_SHINY                          (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_P_FORCE_NO_SHINY                       (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_P_PARTY_MOVE_RELEARNER                 (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_P_SCRIPT_MOVE_RELEARNER                (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_P_LEVEL_UP_MOVES                       (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_P_EGG_MOVES                            (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_P_TUTOR_MOVES                          (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_B_FOLLOWERS_DISABLED                   (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_OW_PAUSE_TIME                          (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_OW_NO_ENCOUNTER                        (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_OW_NO_TRAINER_SEE                      (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_OW_NO_COLLISION                        (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_OW_POKE_RIDER                          (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_I_EXP_SHARE                            (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_I_VS_SEEKER_CHARGING                   (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_NPC_HEAL_AFTER_FOLLOWER_BATTLE         (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_NPC_PARTNER_WILD_BATTLES               (SYSTEM_FLAGS + 0x95) // Unused Flag
#define FLAG_DN_FLAG_SEARCHING                      (SYSTEM_FLAGS + 0x96) // Unused Flag
#define FLAG_DN_FLAG_DEXNAV_GET                     (SYSTEM_FLAGS + 0x97) // Unused Flag
#define FLAG_DN_FLAG_DETECTOR_MODE                  (SYSTEM_FLAGS + 0x98) // Unused Flag
#define FLAG_B_INVERSE_BATTLE                       (SYSTEM_FLAGS + 0x99) // Unused Flag
#define FLAG_B_FORCE_DOUBLE_WILD                    (SYSTEM_FLAGS + 0x9A) // Unused Flag
#define FLAG_B_SMART_WILD_AI                        (SYSTEM_FLAGS + 0x9B) // Unused Flag
#define FLAG_B_NO_BAG_USE                           (SYSTEM_FLAGS + 0x9C) // Unused Flag
#define FLAG_B_NO_CATCHING                          (SYSTEM_FLAGS + 0x9D) // Unused Flag
#define FLAG_B_NO_RUNNING                           (SYSTEM_FLAGS + 0x9E) // Unused Flag
#define FLAG_B_AI_VS_AI_BATTLE                      (SYSTEM_FLAGS + 0x9F) // Unused Flag
#define FLAG_B_DYNAMAX_BATTLE                       (SYSTEM_FLAGS + 0xA0) // Unused Flag
#define FLAG_B_TERA_ORB_CHARGED                     (SYSTEM_FLAGS + 0xA1) // Unused Flag
#define FLAG_B_TERA_ORB_NO_COST                     (SYSTEM_FLAGS + 0xA2) // Unused Flag
#define FLAG_B_SLEEP_CLAUSE                         (SYSTEM_FLAGS + 0xA3) // Unused Flag
#define FLAG_B_NO_WHITEOUT                          (SYSTEM_FLAGS + 0xA4) // Unused Flag
#define FLAG_B_SKY_BATTLE                           (SYSTEM_FLAGS + 0xA5) // Unused Flag
#define FLAG_DERBY_FLAG_NICKNAME                    (SYSTEM_FLAGS + 0xA6) // Unused Flag
#define FLAG_DERBY_FLAG_RESET                       (SYSTEM_FLAGS + 0xA7) // Unused Flag

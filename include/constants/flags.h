...
#define FLAG_B_FLAG_DYNAMAX_BATTLE                  (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_B_FLAG_TERA_ORB_CHARGED                (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_B_FLAG_TERA_ORB_NO_COST                (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_B_FLAG_SLEEP_CLAUSE                    (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_B_FLAG_NO_WHITEOUT                     (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_B_FLAG_AI_VS_AI_BATTLE                 (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_B_FLAG_SKY_BATTLE                      (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_DN_FLAG_SEARCHING                      (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_DN_FLAG_DEXNAV_GET                     (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_DN_FLAG_DETECTOR_MODE                  (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_FNPC_FLAG_HEAL_AFTER_FOLLOWER_BATTLE   (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_FNPC_FLAG_PARTNER_WILD_BATTLES         (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_I_EXP_SHARE_FLAG                       (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_I_VS_SEEKER_CHARGING                   (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_OW_FLAG_SUPPRESS_NAME_BOX              (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_B_FLAG_FOLLOWERS_DISABLED              (SYSTEM_FLAGS + 0x95) // Unused Flag
#define FLAG_OW_FLAG_PAUSE_TIME                     (SYSTEM_FLAGS + 0x96) // Unused Flag
#define FLAG_OW_FLAG_NO_TRAINER_SEE                 (SYSTEM_FLAGS + 0x97) // Unused Flag
#define FLAG_OW_FLAG_NO_COLLISION                   (SYSTEM_FLAGS + 0x98) // Unused Flag
#define FLAG_OW_FLAG_POKE_RIDER                     (SYSTEM_FLAGS + 0x99) // Unused Flag
...
#define FLAG_P_FLAG_SUMMARY_SCREEN_IV_EV_INFO       (SYSTEM_FLAGS + 0x9D) // Unused Flag
#define FLAG_P_FLAG_EGG_MOVES                       (SYSTEM_FLAGS + 0x9E) // Unused Flag
#define FLAG_P_FLAG_TUTOR_MOVES                     (SYSTEM_FLAGS + 0x9F) // Unused Flag
#define FLAG_FLAG_TEXT_SPEED_INSTANT                (SYSTEM_FLAGS + 0xA0) // Unused Flag
#define FLAG_WE_FLAG_NO_ENCOUNTER                   (SYSTEM_FLAGS + 0xA1) // Unused Flag
#define FLAG_WE_FLAG_FORCE_DOUBLE_WILD              (SYSTEM_FLAGS + 0xA2) // Unused Flag
#define FLAG_WE_SMART_WILD_AI_FLAG                  (SYSTEM_FLAGS + 0xA3) // Unused Flag

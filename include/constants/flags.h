...
#define FLAG_B_INVERSE_BATTLE                       (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_B_FORCE_DOUBLE_WILD                    (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_B_SMART_WILD_AI_FLAG                   (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_B_NO_CATCHING                          (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_B_NO_RUNNING                           (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_B_AI_VS_AI_BATTLE                      (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_B_DYNAMAX_BATTLE                       (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_B_TERA_ORB_CHARGED                     (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_B_TERA_ORB_NO_COST                     (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_B_SLEEP_CLAUSE                         (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_B_NO_WHITEOUT                          (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_B_SKY_BATTLE                           (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_DN_SEARCHING                           (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_DN_DEXNAV_GET                          (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_DN_DETECTOR_MODE                       (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_FNPC_HEAL_AFTER_FOLLOWER_BATTLE        (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_FNPC_PARTNER_WILD_BATTLES              (SYSTEM_FLAGS + 0x95) // Unused Flag
#define FLAG_I_EXP_SHARE                            (SYSTEM_FLAGS + 0x96) // Unused Flag
#define FLAG_I_ORAS_DOWSING                         (SYSTEM_FLAGS + 0x97) // Unused Flag
#define FLAG_I_VS_SEEKER_CHARGING                   (SYSTEM_FLAGS + 0x98) // Unused Flag
#define FLAG_OW_SUPPRESS_NAME_BOX                   (SYSTEM_FLAGS + 0x99) // Unused Flag
#define FLAG_B_FOLLOWERS_DISABLED                   (SYSTEM_FLAGS + 0x9A) // Unused Flag
#define FLAG_OW_PAUSE_TIME                          (SYSTEM_FLAGS + 0x9B) // Unused Flag
#define FLAG_OW_NO_ENCOUNTER                        (SYSTEM_FLAGS + 0x9C) // Unused Flag
#define FLAG_OW_NO_TRAINER_SEE                      (SYSTEM_FLAGS + 0x9D) // Unused Flag
#define FLAG_OW_NO_COLLISION                        (SYSTEM_FLAGS + 0x9E) // Unused Flag
#define FLAG_OW_POKE_RIDER                          (SYSTEM_FLAGS + 0x9F) // Unused Flag
#define FLAG_P_FORCE_SHINY                          (SYSTEM_FLAGS + 0xA0) // Unused Flag
#define FLAG_P_FORCE_NO_SHINY                       (SYSTEM_FLAGS + 0xA1) // Unused Flag
#define FLAG_P_SUMMARY_SCREEN_IV_EV_INFO            (SYSTEM_FLAGS + 0xA3) // Unused Flag
#define FLAG_P_EGG_MOVES                            (SYSTEM_FLAGS + 0xA4) // Unused Flag
#define FLAG_P_TUTOR_MOVES                          (SYSTEM_FLAGS + 0xA5) // Unused Flag

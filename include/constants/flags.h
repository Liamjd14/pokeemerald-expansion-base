...
#define FLAG_SYS_BATTLE_INVERSE_BATTLE              (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_SYS_BATTLE_FORCE_DOBLE_WILD            (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_SYS_BATTLE_SMART_WILD_AI               (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_SYS_BATTLE_NO_BAG_USE                  (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_SYS_BATTLE_NO_CATCHING                 (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_SYS_BATTLE_NO_RUNNING                  (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_SYS_BATTLE_AV_VS_AI                    (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_SYS_BATTLE_DYNAMAX_BATTLE              (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_SYS_BATTLE_TERA_ORB_CHARGE             (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_SYS_BATTLE_TERA_ORB_NOCOST             (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_SYS_BATTLE_SLEEP_CLAUSE                (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_SYS_BATTLE_SKY_BATTLE                  (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_SYS_DN_SEARCHING                       (SYSTEM_FLAGS + 0x91) // Unused Flag
#define FLAG_SYS_DN_DEXNAV_GET                      (SYSTEM_FLAGS + 0x92) // Unused Flag
#define FLAG_SYS_DN_DETECTOR_MODE                   (SYSTEM_FLAGS + 0x93) // Unused Flag
#define FLAG_SYS_ITEM_EXP_SHARE_FLAG                (SYSTEM_FLAGS + 0x94) // Unused Flag
#define FLAG_SYS_ITEM_VS_SEEKER_CHARGING            (SYSTEM_FLAGS + 0x95) // Unused Flag
#define FLAG_SYS_OVERWORLD_PAUSE_TIME               (SYSTEM_FLAGS + 0x96) // Unused Flag
#define FLAG_SYS_OVERWORLD_NO_ENCOUNTER             (SYSTEM_FLAGS + 0x97) // Unused Flag
#define FLAG_SYS_OVERWORLD_NO_TRAINER_SEE           (SYSTEM_FLAGS + 0x98) // Unused Flag
#define FLAG_SYS_OVERWORLD_NO_COLLISION             (SYSTEM_FLAGS + 0x99) // Unused Flag
#define FLAG_SYS_OVERWORLD_POKE_RIDE                (SYSTEM_FLAGS + 0x9A) // Unused Flag
...
#define FLAG_SYS_PARTY_MOVE_RELEARNER               (SYSTEM_FLAGS + 0x9F) // Unused Flag
#define FLAG_SYS_SCRIPT_MOVE_RELEARNER              (SYSTEM_FLAGS + 0xA0) // Unused Flag
#define FLAG_SYS_LEVEL_UP_MOVES                     (SYSTEM_FLAGS + 0xA1) // Unused Flag
#define FLAG_SYS_EGG_MOVES                          (SYSTEM_FLAGS + 0xA2) // Unused Flag
#define FLAG_SYS_TUTOR_MOVES                        (SYSTEM_FLAGS + 0xA3) // Unused Flag

...
static const enum Item sPrizeListRoar[]        = {ITEM_TM_OUTRAGE,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListSludgeBomb[]  = {ITEM_TM_OUTRAGE,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListToxic[]       = {ITEM_TM_OUTRAGE,         ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListSunnyDay[]    = {ITEM_TM_OUTRAGE,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListEarthQuake[]  = {ITEM_TM_OUTRAGE,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListBrickBreak[]  = {ITEM_TM_OUTRAGE,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListTorment[]     = {ITEM_TM_OUTRAGE,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListSkillSwap[]   = {ITEM_TM_OUTRAGE,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListGigaDrain[]   = {ITEM_TM_OUTRAGE,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListAttract[]     = {ITEM_TM_OUTRAGE,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};

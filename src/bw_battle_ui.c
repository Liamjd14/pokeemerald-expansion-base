        ...
        if (moveId != MOVE_NONE)
        {
            ...
            if (gBattleResources->bufferA[battler][2] != TRUE)
            {
                ...
                *(txtPtr)++ = CHAR_SLASH;
                ...
                AddTextPrinterParameterized6(windowId, FONT_SMALL, x, 4, 0, 0, clr, TEXT_SKIP_DRAW, gDisplayedStringBattle);
                //AddTextPrinterParameterized5(windowId, FONT_SMALL, gDisplayedStringBattle, x, 4, TEXT_SKIP_DRAW, NULL, 0, 0);
            }
        }
...
static void BattleUI_AddTextPrinter(u32 windowId, u32 fontId, u32 x, u32 y, enum BattleUITextColors color, const u8 *str)
{
    ...
    //AddTextPrinterParameterized5(windowId, fontId, str, x, y, TEXT_SKIP_DRAW, NULL, 0, 0);
}

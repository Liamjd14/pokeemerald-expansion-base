...
const struct SpriteFrameImage gObjectEventPicTable_Test[] = {
    ...
    overworld_frame(gObjectEventPic_Test, 4, 4, 6),
    overworld_frame(gObjectEventPic_Test, 4, 4, 7),
    overworld_frame(gObjectEventPic_Test, 4, 4, 8),
};
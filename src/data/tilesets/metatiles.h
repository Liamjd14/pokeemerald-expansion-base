...
const u16 gMetatiles_PokecenterAlt[] = INCBIN_U16("data/tilesets/secondary/pokecenter_alt/metatiles.bin");
const u16 gMetatileAttributes_PokecenterAlt[] = INCBIN_U16("data/tilesets/secondary/pokecenter_alt/metatile_attributes.bin");

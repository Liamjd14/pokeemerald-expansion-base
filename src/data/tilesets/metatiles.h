...
const u16 gMetatiles_EshosPrimary[] = INCBIN_U16("data/tilesets/primary/eshos_primary/metatiles.bin");
const u16 gMetatileAttributes_EshosPrimary[] = INCBIN_U16("data/tilesets/primary/eshos_primary/metatile_attributes.bin");

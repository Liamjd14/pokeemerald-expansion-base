...
const struct Tileset gTileset_ES_Evergreen =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_ES_Evergreen,
    .palettes = gTilesetPalettes_ES_Evergreen,
    .metatiles = gMetatiles_ES_Evergreen,
    .metatileAttributes = gMetatileAttributes_ES_Evergreen,
    .callback = NULL,
};

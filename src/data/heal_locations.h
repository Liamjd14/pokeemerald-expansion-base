static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_OCEANVIEW - 1] = {MAP_GROUP(OCEANVIEW), MAP_NUM(OCEANVIEW), 13, 10},
    [HEAL_LOCATION_DAWNCORAL - 1] = {MAP_GROUP(DAWNCORAL), MAP_NUM(DAWNCORAL), 49, 13},
    [HEAL_LOCATION_SHADEWIND - 1] = {MAP_GROUP(SHADEWIND), MAP_NUM(SHADEWIND), 31, 22},
};

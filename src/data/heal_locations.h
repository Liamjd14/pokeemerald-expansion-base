static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EVERGREEN - 1] = {MAP_GROUP(EVERGREEN), MAP_NUM(EVERGREEN), 3, 15},
    [HEAL_LOCATION_DRAGON_LAKEFRONT - 1] = {MAP_GROUP(DRAGON_LAKEFRONT), MAP_NUM(DRAGON_LAKEFRONT), 29, 28},
    [HEAL_LOCATION_SHADEWIND - 1] = {MAP_GROUP(SHADEWIND), MAP_NUM(SHADEWIND), 29, 30},
};

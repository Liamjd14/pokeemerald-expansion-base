...
static void PrintMonStats()
{
    u8 i;
    u16 currentStat;
    u16 nature = GetMonData(ReturnPartyMon(), MON_DATA_HIDDEN_NATURE);
    u8 text[2];
    ...
    u16 ability = GetMonData(ReturnPartyMon(), MON_DATA_ABILITY_NUM);
    ...
    //StringCopy(gStringVar2, gAbilitiesInfo[GetAbilityBySpecies(species, 0)].name);
